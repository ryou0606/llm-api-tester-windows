...
下载源码压缩包，解压后双击 `build.bat` 即可打包运行：

**[📥 下载 Windows 源码包](https://github.com/ryou0606/llm-api-tester-windows/releases/latest/download/llm-api-tester-windows-src.zip)**

```bash
# 解压后进入目录
cd llm-api-tester-windows
